...
//break;
    ...
    fo.close();
    //embedding->get_selected()->erase(embedding->get_selected()->begin()+100);
    //bool kt = test_chain_connection(embedding, P);
    //cout << kt;
    //bool kt2 = test_global_connection(embedding, P);
    //cout << kt2;
    //bool kt3 = test_onetomany_connection(embedding, P);
    //cout << kt3;
